pandoc fcn_all_lib.md -o fcn_all_lib.pdf --pdf-engine=xelatex -V geometry:margin=2cm --from=markdown+tex_math_single_backslash -V header-includes="\usepackage{needspace}"
